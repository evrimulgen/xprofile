...
_L1:
    ...
    protected JsonMappingException wrapException(Throwable throwable)
    {
        ...
        if(throwable1 instanceof JsonMappingException)
            ...
            return new JsonMappingException((new StringBuilder()).append("Instantiation of ").append(getValueTypeDesc()).append(" value failed: ").append(throwable1.getMessage()).toString(), throwable1);
    }
