...
_L2:
        ...
        {
            throw new IllegalArgumentException((new StringBuilder()).append("Failed to access @JsonValue of Enum value ").append(enum).append(": ").append(exception.getMessage()).toString());
        }
        if(obj == null)
