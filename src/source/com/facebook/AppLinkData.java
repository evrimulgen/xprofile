...
public class AppLinkData
{
    ...
    private static AppLinkData createFromJson(String s)
    {
        ...
        String s1;
        JVM INSTR new #158 <Class JSONObject>;
        jsonobject = JSONObjectInstrumentation.init(s);
        s1 = jsonobject.getString("version");
        if(!jsonobject.getJSONObject("bridge_args").getString("method").equals("applink") || !s1.equals("2")) goto _L2; else goto _L1
_L1:
        AppLinkData applinkdata;
        applinkdata = new AppLinkData();
        applinkdata.arguments = jsonobject.getJSONObject("method_args");
        if(!applinkdata.arguments.has("ref")) goto _L4; else goto _L3
_L3:
...
_L2:
        return null;
_L4:
        if(!applinkdata.arguments.has("referer_data")) goto _L6; else goto _L5
_L5:
    ...
    public static void fetchDeferredAppLinkData(Context context, String s, CompletionHandler completionhandler)
    {
        ...
        String s1 = s;
        Settings.getExecutor().execute(new Runnable(context1, s1, completionhandler) {
...
_L10:
        if(s4 == null) goto _L4; else goto _L7
_L7:
        if(applinkdata.arguments != null)
