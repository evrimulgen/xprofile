...
public class StdContainerSerializers
{
    ...
    public static ContainerSerializer collectionSerializer(JavaType javatype, boolean flag, TypeSerializer typeserializer, BeanProperty beanproperty, JsonSerializer jsonserializer)
    {
        return collectionSerializer(javatype, flag, typeserializer, jsonserializer);
    }
    ...
    public static ContainerSerializer indexedListSerializer(JavaType javatype, boolean flag, TypeSerializer typeserializer, BeanProperty beanproperty, JsonSerializer jsonserializer)
    {
        return indexedListSerializer(javatype, flag, typeserializer, jsonserializer);
    }
