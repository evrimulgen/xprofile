        ...
        do
        {
            ...
            if(iterator.hasNext())
            {
                ...
                if(((HashMap) (obj1)).put(s, annotatedmember) != null)
                    throw new IllegalArgumentException((new StringBuilder()).append("Multiple back-reference properties with name '").append(s).append("'").toString());
            } else
            {
                return ((Map) (obj));
            }
    ...
    protected boolean isFactoryMethod(AnnotatedMethod annotatedmethod)
    {
        ...
        if(getBeanClass().isAssignableFrom(class1))
        {
            ...
            if("fromString".equals(s) && 1 == annotatedmethod.getParameterCount())
            {
                ...
                if(class2 == java/lang/String || java/lang/CharSequence.isAssignableFrom(class2))
                    return true;
            }
        }
        return false;
