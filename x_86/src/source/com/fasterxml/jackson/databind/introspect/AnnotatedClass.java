...
_L1:
    ...
    protected AnnotatedConstructor _constructConstructor(Constructor constructor, boolean flag)
    {
        ...
        if(i != aannotation.length)
        {
            ...
            if(aannotationmap == null)
                throw new IllegalStateException((new StringBuilder()).append("Internal error: constructor for ").append(constructor.getDeclaringClass().getName()).append(" has mismatch: ").append(i).append(" parameters; ").append(aannotation1.length).append(" sets of annotations").toString());
        } else
        {
    ...
    protected Map _findFields(Class class1, Map map)
    {
        ...
        if(class2 != null)
        {
            Map map1 = _findFields(class2, map);
            ...
            if(_mixInResolver != null)
            {
                ...
                if(class3 != null)
                    _addFieldMixIns(class2, class3, ((Map) (obj)));
            }
            return ((Map) (obj));
        } else
        {
