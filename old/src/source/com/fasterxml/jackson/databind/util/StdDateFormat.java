...
_L2:
    ...
    public Date parse(String s, ParsePosition parseposition)
    {
        ...
        if(i < 0 && (s.charAt(0) == '-' || NumberInput.inLongRange(s, false)))
...
_L8:
    ...
    {
        String s = (new StringBuilder()).append("DateFormat ").append(getClass().getName()).toString();
        TimeZone timezone = _timezone;
        if(timezone != null)
            s = (new StringBuilder()).append(s).append(" (timezone: ").append(timezone).append(")").toString();
        return s;
    }
