    ...
    implements Serializable
{
        ...
        throws JsonMappingException
    {
        ...
        com.fasterxml.jackson.databind.BeanProperty.Std std = new com.fasterxml.jackson.databind.BeanProperty.Std(propertyname, javatype, beanpropertydefinition.getWrapperName(), propertybuilder.getClassAnnotations(), annotatedmember, beanpropertydefinition.getMetadata());
        JsonSerializer jsonserializer = findSerializerFromAnnotation(serializerprovider, annotatedmember);
        if(jsonserializer instanceof ResolvableSerializer)
            ((ResolvableSerializer)jsonserializer).resolve(serializerprovider);
        JsonSerializer jsonserializer1 = serializerprovider.handlePrimaryContextualization(jsonserializer, std);
        ...
        return propertybuilder.buildWriter(serializerprovider, beanpropertydefinition, javatype, jsonserializer1, findPropertyTypeSerializer(javatype, serializerprovider.getConfig(), annotatedmember), typeserializer, annotatedmember, flag);
    }
...
_L5:
        ...
        throws JsonMappingException
    {
        ...
        } else
        {
            ...
            if(annotatedmember != null)
            {
                ...
                MapSerializer mapserializer = MapSerializer.construct(null, javatype, flag, createTypeSerializer(serializationconfig, javatype1), null, null, null);
                beanserializerbuilder.setAnyGetter(new AnyGetterWriter(new com.fasterxml.jackson.databind.BeanProperty.Std(new PropertyName(annotatedmember.getName()), javatype1, null, beandescription.getClassAnnotations(), annotatedmember, PropertyMetadata.STD_OPTIONAL), annotatedmember, mapserializer));
            }
        ...
        throws JsonMappingException
    {
        ...
        {
            String s = objectidinfo.getPropertyName().getSimpleName();
            int i = list.size();
            int j = 0;
            do
            {
                if(j == i)
                    throw new IllegalArgumentException((new StringBuilder()).append("Invalid Object Id definition for ").append(beandescription.getBeanClass().getName()).append(": can not find property with name '").append(s).append("'").toString());
