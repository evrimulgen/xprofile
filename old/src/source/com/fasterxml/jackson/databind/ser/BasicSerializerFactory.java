    ...
    implements Serializable
{
        ...
        throws JsonMappingException
    {
        ...
        CollectionLikeType collectionliketype1;
        Iterator iterator;
...
_L3:
        jsonserializer2 = buildMapSerializer(serializationconfig, (MapType)mapliketype, beandescription, flag1, jsonserializer3, typeserializer, jsonserializer);
_L6:
        return jsonserializer2;
_L4:
        for(iterator2 = customSerializers().iterator(); iterator2.hasNext();)
        {
            serializers = (Serializers)iterator2.next();
            mapliketype1 = (MapLikeType)javatype;
            ...
            if(jsonserializer1 != null)
            {
                ...
                iterator3 = _factoryConfig.serializerModifiers().iterator();
...
_L2:
        ...
        if(collectionliketype.isTrueCollectionType())
            return buildCollectionSerializer(serializationconfig, (CollectionType)collectionliketype, beandescription, flag1, typeserializer, jsonserializer);
        collectionliketype1 = (CollectionLikeType)javatype;
...
_L5:
        ...
        if(javatype.isArrayType())
            return buildArraySerializer(serializationconfig, (ArrayType)javatype, beandescription, flag1, typeserializer, jsonserializer);
        else
            return null;
        ...
        throws JsonMappingException
    {
        ...
        if(obj == null)
            ...
            {
                Object obj2 = findFilterId(serializationconfig, beandescription);
                obj = MapSerializer.construct(serializationconfig.getAnnotationIntrospector().findPropertiesToIgnore(beandescription.getClassInfo()), maptype, flag, typeserializer, jsonserializer, jsonserializer1, obj2);
            }
        if(_factoryConfig.hasSerializerModifiers())
        {
