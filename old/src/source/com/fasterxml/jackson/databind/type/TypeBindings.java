...
_L3:
        ...
        if(atypevariable1.length != atype1.length)
            throw new IllegalArgumentException((new StringBuilder()).append("Strange parametrized type (in class ").append(class4.getName()).append("): number of type arguments != number of type parameters (").append(atype1.length).append(" vs ").append(atypevariable1.length).append(")").toString());
        l = atype1.length;
        i1 = 0;
_L8:
