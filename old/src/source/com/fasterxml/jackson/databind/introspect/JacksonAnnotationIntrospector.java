    ...
    implements Serializable
{
    ...
    {
        JsonFilter jsonfilter = (JsonFilter)annotated.getAnnotation(com/fasterxml/jackson/annotation/JsonFilter);
        if(jsonfilter != null)
        {
...
label0:
    ...
    public Object findNullSerializer(Annotated annotated)
    {
        ...
        if(jsonserialize != null)
        {
            Class class1 = jsonserialize.nullsUsing();
            if(class1 != com/fasterxml/jackson/databind/JsonSerializer$None)
                return class1;
        }
        return null;
    ...
    {
        JsonPropertyDescription jsonpropertydescription = (JsonPropertyDescription)annotated.getAnnotation(com/fasterxml/jackson/annotation/JsonPropertyDescription);
