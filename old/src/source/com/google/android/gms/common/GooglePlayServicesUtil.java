...
_L4:
    ...
    public static Dialog a(int i, Activity activity, int j, android.content.DialogInterface.OnCancelListener oncancellistener, int k)
    {
        ...
        ef ef1 = new ef(activity, a(((Context) (activity)), i, k), j);
        String s1 = b(activity, i);
        if(s1 != null)
...
_L8:
    ...
    {
        Dialog dialog = getErrorDialog(i, activity, j, oncancellistener);
        if(dialog == null)
            return false;
        boolean flag;
        try
        ...
        if(flag)
        {
            ...
            com.google.android.gms.common.b.a(dialog, oncancellistener).show(fragmentmanager1, "GooglePlayServicesErrorDialog");
        } else
        if(fr.eJ())
        {
