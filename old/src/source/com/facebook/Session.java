        ...
        if(sessionstate != newState || sessionstate == SessionState.OPENED_TOKEN_UPDATED || exception != null)
        {
            ...
            Runnable runnable = new Runnable() {
                ...
                public void run()
                {
                    ...
                    JVM INSTR monitorenter ;
                    Runnable runnable1;
                    for(Iterator iterator = callbacks.iterator(); iterator.hasNext(); Session.runWithHandlerOrExecutor(handler, runnable1))
                        runnable1 = ((StatusCallback)iterator.next()). new Runnable() {
