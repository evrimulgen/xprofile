...
public class ActionBarActivity extends FragmentActivity
    implements ActionBar.Callback, android.support.v4.app.TaskStackBuilder.SupportParentable, android.support.v4.app.ActionBarDrawerToggle.DelegateProvider, TraceFieldInterface
{
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        TraceMachine.enterMethod(_nr_trace, "ActionBarActivity#onCreate", null);
_L1:
