...
label0:
        ...
        throws IOException
    {
        if(detectEncoding() == JsonEncoding.UTF8 && flag)
        {
            ...
            return new UTF8StreamJsonParser(_context, i, _in, objectcodec, bytestonamecanonicalizer1, _inputBuffer, _inputPtr, _inputEnd, _bufferRecyclable);
        } else
        {
...
_L9:
        ...
        return jsonencoding;
_L3:
        if(handleBOM(i) || checkUTF32(i) || checkUTF16(i >>> 16)) goto _L7; else goto _L6
_L6:
        flag = false;
        break; /* Loop/switch isn't completed */
_L2:
        if(!ensureLoaded(2) || !checkUTF16((0xff & _inputBuffer[_inputPtr]) << 8 | 0xff & _inputBuffer[1 + _inputPtr])) goto _L6; else goto _L7
_L5:
