    ...
    implements TypeResolverBuilder
{
    ...
    public TypeDeserializer buildTypeDeserializer(DeserializationConfig deserializationconfig, JavaType javatype, Collection collection)
    {
        ...
        case 1: // '\001'
            return new AsArrayTypeDeserializer(javatype, typeidresolver, _typeProperty, _typeIdVisible, _defaultImpl);

        case 2: // '\002'
            return new AsPropertyTypeDeserializer(javatype, typeidresolver, _typeProperty, _typeIdVisible, _defaultImpl);

        case 3: // '\003'
            return new AsWrapperTypeDeserializer(javatype, typeidresolver, _typeProperty, _typeIdVisible, _defaultImpl);

        case 4: // '\004'
            return new AsExternalTypeDeserializer(javatype, typeidresolver, _typeProperty, _typeIdVisible, _defaultImpl);
        }
    }
