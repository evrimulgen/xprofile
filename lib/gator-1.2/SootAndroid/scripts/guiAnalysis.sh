...
#                          debug information.
#   * $SootAndroidMaxHeap: used to specify the maximum heap size to run our
#                          analysis. If not specified, the default value 4 GB
#                          will be used.
