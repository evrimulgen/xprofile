...
public abstract class NNode {
  ...
  public Iterator<NNode> getSuccessors() {
  ...
  public NNode getSuccessor(int index) {
    return succ.get(index);
  }

  public Iterator<NNode> getPredecessors() {
  ...
  public NNode getPredecessor(int index) {
    return pred.get(index);
  }

  public boolean hasChild(NNode child) {
    if (children == null) {
      return false;
    }
  ...
  public Iterator<NNode> getParents() {
  ...
  public void removeEdgeTo(NNode target) {
  ...
  public void addEdgeTo(NNode x) {
    addEdgeTo(x, null);
  }

  public void addEdgeTo(NNode x, Stmt s) {
    if (succ == null) {
  ...
  public boolean addTextNode(NNode text) {
    if (textNodes == null) {
